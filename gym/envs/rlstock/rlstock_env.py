...
df = pd.read_csv('/Users/guillaumepoidatz/Documents/VENV/BackTest/lib/python3.12/site-packages/gym/envs/rlstock/Data_Daily_Stock_Dow_Jones_30/dow_jones_30_daily_price.csv')
...
def data_preprocess_train(df):
    ...
    data_2 = data_1.loc[data_1.tic.isin(select_stocks_list)][~data_1.datadate.isin(['20010912','20010913'])]
