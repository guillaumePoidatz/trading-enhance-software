...
# Charger les données DJI
dji = pd.read_csv('/Users/guillaumepoidatz/Documents/VENV/BackTest/lib/python3.12/site-packages/gymnasium/envs/rlstock/Data_Daily_Stock_Dow_Jones_30/^DJI.csv')
...
# Charger les données des actions du Dow Jones
...
def data_preprocess_test(df):
    ...
    test_daily_data = [test_data[test_data.datadate == date] for date in np.unique(test_data.datadate)]
